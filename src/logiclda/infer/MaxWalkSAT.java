...
public class MaxWalkSAT {
	...
	public static void main(String [] args)
	{
		...
		doMWS(grules, p, numiter, prand, s, randseed);
		...
		MirrorDescent md = new MirrorDescent(rules, randseed);
	...
	public static DiscreteSample doMWS(List<GroundableRule> lstRules,
			LDAParameters p,
			int numiter, 
			double prand, DiscreteSample s, int randseed)			
	{
		
		// Init data structures
		//
		GroundRules gr = new GroundRules(lstRules, s.z, randseed);
